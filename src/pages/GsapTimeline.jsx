...
const GsapTimeline = () => {
  ...
  // Create a reusable GSAP timeline instance
  const timeline = gsap.timeline({
    repeat: -1,       // infinite loop
    repeatDelay: 1,   // wait 1s before repeating
    yoyo: true        // reverse the animation after each cycle
  });

  useGSAP(() => {
    // Step 1: Move right, spin & morph into a circle
    ...
    // Step 2: Move down, scale up & spin again
    timeline.to("#yellow-box", {
      y: 250,
      scale: 2,
      rotation: 360,
    ...
    // Step 3: Move further right, reset scale & become a square again
    timeline.to("#yellow-box", {
      x: 500,
      scale: 1,
      rotation: 360,
  ...
  return (
    <main>
      ...
      <div className="mt-20 space-y-10">
        {/* Play / Pause button toggles timeline */}
        <button onClick={() => {
          if (timeline.paused()) {
            timeline.play()
          } else {
