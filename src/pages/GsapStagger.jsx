...
const GsapStagger = () => {
  ...
  useGSAP(() => {
    gsap.to(".stagger-box", {
      y: 250,              // move down
      rotation: 360,       // spin
      borderRadius: "100%",// morph into circle
      repeat: -1,          // infinite loop
      yoyo: true,          // back and forth

      // 🔹 Stagger configuration
      stagger: {
        amount: 1.5,       // total delay time for the stagger group
        grid: [2, 1],      // arrange items in 2 rows & 1 column
        axis: "y",         // stagger along Y-axis
        ease: "circ.inOut",// easing for stagger timing
        from: "center",    // start staggering from the center element
      },
    })
  }, [])
