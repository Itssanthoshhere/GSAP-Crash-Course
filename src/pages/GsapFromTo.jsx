  ...
  useGSAP(() => {
    gsap.fromTo(
      "#red-box",
      {
        ...
        borderRadius: "0%" // start as a square
      },
      {
        // Ending properties
        x: 250,              // move 250px right
        rotation: 360,       // full spin
        borderRadius: "100%",// transform into a circle

        // nimation controls
        repeat: -1,       // loop infinitely
        yoyo: true,       // go back to start after each loop
        duration: 2,      // 2 seconds per cycle
        ease: "bounce.out"// bouncy easing effect
      }
    )
  }, []);
